...
public class ControllerInput_old
{
    //REFERENCES
    ...
    private List<ControllerInputListener_old> listeners = new ArrayList<ControllerInputListener_old>();

    //Add a new listener
    public void addListener(ControllerInputListener_old toAdd) {
        listeners.add(toAdd);
    }
    
    //Initializer
    public ControllerInput_old(Gamepad setGamepad, int setId){
        gamepad = setGamepad;
        id = setId;
    }
    ...
    public void APressed() {
        for (ControllerInputListener_old controllerInput : listeners)
    ...
    public void LTReleased() {
        for (ControllerInputListener_old inputListener : listeners)
