...
public class CuriosityRobot extends MecanumChassis
{
    ...
    public CuriosityRobot(OpMode setOpMode, boolean useChassis, boolean usePayload, boolean useNavigator) {
        super(setOpMode, new _ChassisProfile(), new HermesLog("Curiosity", 500, setOpMode), new BaseRobot(BaseRobot.FieldSide.BLUE,new Pose(0,0,0),useChassis,usePayload,useNavigator));
